...
BOT_TOKEN = environ.get('BOT_TOKEN', "5958171210:AAH5QFihxHeVYRX1fEytGg3ennuUeqXzSng")
...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/+pVPv69822bhmMmZl")
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5431249569').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001504505611')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001504505611')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://fireboy:fireboy@useless.aqgwios.mongodb.net/?retryWrites=true&w=majority")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/tamil_rockerz1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+pVPv69822bhmMmZl')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001826337217'))
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"{script.CAPTION} @tamil_linkz1")
